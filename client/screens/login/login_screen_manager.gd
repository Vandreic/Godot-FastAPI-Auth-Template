...
## with the backend. Transitions to the name entry screen on successful authentication. [br][br]
## 
## Extends [BaseScreenTemplateManager].
...
## Transitions to the language selection screen.
func _on_change_language_button_pressed() -> void:
	# Change to language selection screen
