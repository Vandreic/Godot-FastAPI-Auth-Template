...
##
## Prompts the user to enter their name with validation. Saves the name and
## transitions to the home screen on continue. [br][br]
## 
## Extends [BaseScreenTemplateManager].
...
## Regex used to validate the name input (letters, spaces, hyphens, apostrophes).
